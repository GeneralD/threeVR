 ...
 * @param object
 * @param domElement parse user controlling for this DOM element
 * @param {boolean} [preventDefault=true] invoke preventDefault function for each event
 * @param {boolean} [stopPropagation=true] invoke stopPropagation function for each event
 * @constructor
 */
var DeviceOrientationController = function (object, domElement, preventDefault, stopPropagation) {
	this.object = object;
	this.element = domElement || document;
	this.preventDefault = typeof (preventDefault) !== 'boolean' ? true : preventDefault;
	this.stopPropagation = typeof (stopPropagation) !== 'boolean' ? true : stopPropagation;
